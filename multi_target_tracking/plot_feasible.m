% JBS 
% modifications
% removed the contour of objective function (line 372)
% axis will be set externally. so do not set here (line 204)
...
%                        crosshatching.
%
%    'plot_vertices'     if defined indicates that we should plot the
...
% set(gca, 'ylim', [lower_b(2)-diff_y upper_b(2)+diff_y]); vertices of the feasible region
%                        the value will determine the symbol to use to plot the vertices,
%                        e.g., 'rx', or 'o+'
hold on
epsilon = 1.0e-14;
...
% 			     'color', linecolor, 'linestyle', inestyle, 'linewidth', linewidth);
    end
  end
end
