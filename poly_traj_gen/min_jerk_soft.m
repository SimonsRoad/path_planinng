...
function [pxs,pys,pzs]=min_jerk_soft(ts,xs,ys,zs,xdot0,ydot0,zdot0,w_j)
   ...
   insert_range1=1:poly_order+1; insert_range2=insert_range1+poly_order+1;
    ...
    Hx=H_wpnt_x; Hy=H_wpnt_y; Hz=H_wpnt_z;
   
    pxs=quadprog(2*Qx,Hx,[],[],Aeq,beq_x);
    pys=quadprog(2*Qx,Hy,[],[],Aeq,beq_y);
    pzs=quadprog(2*Qx,Hz,[],[],Aeq,beq_z);
