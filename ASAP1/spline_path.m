classdef spline_path < handle 
    ...
    methods
        ...
        Qx=Q_j; Qy=Qx; Hx=zeros(1,n+1); Hy=Hx;
        w=spline_path.w_d;
...
%              
               ...
               % method 1 : box including the circle 
...
%                right_upper_corner= boundary_center+[boundary_rad boundary_rad];
               ...
               for j=1:N_sample
                   t=t_obs_sample(j);
                   A=[A ; spline_path.t_vec(t,0)' ; -spline_path.t_vec(t,0)'];
                   bx=[bx; right_upper_corner(1) ; -left_lower_corner(1)]; 
