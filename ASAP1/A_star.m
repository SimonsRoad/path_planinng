function local_path=A_star(occu_map,x0,xf,lower_left,upper_right)
addpath('./Astar/')
% this function is API of A star algorithm 
% x0, xf, lower_left and upper right is R2 
% occu_map is binary matrix where 1 is obstacle / 0 is free (logical)

[Nx,Ny]=size(occu_map);
dx=(upper_right(1)-lower_left(1))/Nx;            
dy=(upper_right(2)-lower_left(2))/Ny;
